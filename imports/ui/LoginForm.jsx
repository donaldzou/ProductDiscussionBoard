...
export const LoginForm = () => {
    ...
    var error_msg = ""
    const login_alert = document.getElementById("error_alert")
    function submit(e){
    ...
    return(
        <Form onSubmit={submit}>
            <h1 className="LoginHeader mb-4">Login to Discussion Board</h1>
            <Alert variant="danger" id="error_alert" className="d-none">
                {error_msg}
            </Alert>
